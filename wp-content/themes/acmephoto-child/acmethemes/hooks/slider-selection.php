...
if ( !function_exists('acmephoto_default_slider') ) :
    function acmephoto_default_slider(){
        ...
        $bg_image_style .= 'background-image:url(' . esc_url( get_template_directory_uri()."/assets/img/Gigs-Live-Music.jpg" ) . ');background-repeat:no-repeat;background-size:cover;background-attachment:scroll;background-position: center;';
