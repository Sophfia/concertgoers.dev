	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			while ( have_posts() ) : the_post();
				...
				get_template_part( 'template-parts/content', 'single-venue' );
				...
				echo types_render_field("name-of-venue", array("argument1"=>"value1","argument2"=>"value2","argument2"=>"value2"));
				echo types_render_field("venue-street", array("argument1"=>"value1","argument2"=>"value2","argument2"=>"value2"));
				/**
